...
public class DropDownMenu {
	...
	public void setDropDownMenu(final ComboBox<String> startB, final ComboBox<String> startR, final ComboBox<String> endB, final ComboBox<String> endR, final Button submit) {
		...
		List<Node> allNodes = new ArrayList<Node>(this.nlist);
